...
{
#line 85 "settings/settings_parser.y" /* yacc.c:1909  */
...
#line 87 "settings/settings_parser.h" /* yacc.c:1909  */
};
...
#line 74 "settings/settings_parser.y" /* yacc.c:1909  */

	#define YY_DECL \
		int settings_parser_lex(SETTINGS_PARSER_STYPE *yylval, void *yyscanner)
	YY_DECL;

#line 105 "settings/settings_parser.h" /* yacc.c:1909  */
